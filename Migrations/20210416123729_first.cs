    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LeaugeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeagueSponsor", x => new { x.LeaugeId, x.SponsorId });
                    table.ForeignKey(
                        name: "FK_LeagueSponsor_Leagues_LeagueId",
                        column: x => x.LeagueId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeagueSponsor_LeagueId",
                table: "LeagueSponsor",
                column: "LeagueId");
